...
(function() {
    ...
    add1(k, "いいよ！来いよ！胸にかけて胸に！", "mp3", {volume: 0.6});
    add1(k, "おまたせ", "mp3", {volume: 1});
    add1(k, "お前のことが好きだったんだよ！", "mp3", {volume: 0.6});
    add1(k, "こ↑こ↓", "mp3", {volume: 0.7});
    add1(k, "これもうわかんねぇな", "mp3", {volume: 1});
    add1(k, "じゃけん夜行きましょうね", "mp3", {volume: 0.8});
    add1(k, "ちょっと歯当たんよ～", "mp3", {volume: 0.5});
    add1(k, "ほらいくどー", "mp3", {volume: 0.6});
    add1(k, "やっぱ好きなんすねぇ", "mp3", {volume: 0.6});
    add1(k, "イキスギィ！ンアッー！", "mp3", {volume: 0.6});
    add1(k, "オッスお願いしま～す", "mp3", {volume: 0.8});
    add1(k, "カンノミホ", "mp3", {volume: 0.8});
    add1(k, "ファッ！？", "mp3", {volume: 1});
    add1(k, "学生です", "mp3", {volume: 0.8});
    add1(k, "悔い改めて", "mp3", {volume: 0.6});
